...
vector<vector<ll>> matrix(vector<vector<ll>> s, vector<vector<ll>> t){
    ...
    tt[0][0] = (s[0][0]*t[0][0]%Mod + s[0][1]*t[1][0]%Mod)%Mod;
    tt[0][1] = (s[0][0]*t[0][1]%Mod + s[0][1]*t[1][1]%Mod)%Mod;
    tt[1][0] = (s[1][0]*t[0][0]%Mod + s[1][1]*t[1][0]%Mod)%Mod;
    tt[1][1] = (s[1][0]*t[0][1]%Mod + s[1][1]*t[1][1]%Mod)%Mod;
...
int main(){
    ...
    ll b = (result[0][1] * result[0][0]) % Mod;
